...
class DesaController extends Controller
{
    ...
    {
        $desa = DesaModel::all();
        return view('pages.admin.desa.index', compact('desa'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.desa.create', compact('kabupaten'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.admin.desa.edit', compact('desa', 'kecamatanWithKabupaten'));
    }
