...
class KecamatanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.admin.kecamatan.create', compact('kabupaten'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('wilayah-kecamatan.index');
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.admin.kecamatan.edit', compact('kecamatan', 'kabupaten'));
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            if ($kecamatan->desas()->count() > 0) {
                ...
                return redirect()->route('wilayah-kecamatan.index')->with('error_message_delete', $errorMessage);
            }
            $kecamatan->delete();

            return redirect()->route('wilayah-kecamatan.index')->with('success_message_delete', 'Data kecamatan berhasil dihapus');
        } catch (ModelNotFoundException $e) {
            return redirect()->route('wilayah-kecamatan.index')->with('error_message_not_found', 'Data kecamatan tidak ditemukan');
        } catch (QueryException $e) {
            if ($e->getCode() === '23000') {
