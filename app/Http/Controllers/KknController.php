...
class KknController extends Controller
{
    ...
    {
        $kkn = KknModel::all();
        return view('pages.admin.kkn.index', compact('kkn'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.kkn.create', compact('desa', 'periode', 'skema'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kkn.index');
    ...
    public function edit(string $id)
    {
        try {
            ...
            return redirect()->route('kkn.index')->with('error_message_not_found', 'Data kkn tidak ditemukan');
        }
        return view('pages.admin.kkn.edit', compact('kkn', 'desa', 'periode', 'skema', 'persyaratan'));
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('kkn.index')->with('success_message_delete', 'Data kkn berhasil dihapus');
        } catch (ModelNotFoundException $e) {
            return redirect()->route('kkn.index')->with('error_message_not_found', 'Data kkn tidak ditemukan');
        } catch (QueryException $e) {
            if ($e->getCode() === '23000') {
