    ...
    public function index(Request $request)
{
    ...
    // dd($kkn->toArray());
    return view('pages.admin.kkn-mahasiswa.index', compact('skema', 'kkn', 'search', 'selectedSkema'));
}
...
public function kelompok(Request $request, string $nama, string $periode)
{
    ...
    return view('pages.admin.kkn-mahasiswa.kelompok', compact('kkn', 'paginatedItems', 'search', 'kelompokList'));
}
    ...
    public function allPeserta(string $nama, string $periode)
    {
        try {
            ...
            return redirect()->route('list.kkn.peserta')->with('error_message_not_found', 'Data peserta kkn tidak ditemukan');
        }
        return view('pages.admin.kkn-mahasiswa.list-peserta', compact('kkn', 'mahasiswaList'));
    }

    public function listAnggotaKelompok(string $nama, string $periode, string $id)
    {
        try {
            $kkn = KknModel::where('nama', $nama)
            ->whereHas('periode', function ($query) use ($periode) {
        ...
        return view('pages.admin.kkn-mahasiswa.anggota', compact('kkn', 'mahasiswaList'));
    }
