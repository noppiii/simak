...
class StaffAnggotaKelompokController extends Controller
{
    /**
    ...
    public function index(string $nama, string $periode, string $id)
    {
        ...
        return view('pages.staff.anggota-kelompok.index', compact('kkn', 'mahasiswaList', 'dpl'));
    }
    ...
    public function create(string $nama, string $periode, string $id)
    {
        ...
        // dd($mahasiswaList->toArray());
        return view('pages.staff.anggota-kelompok.create', compact('kkn', 'mahasiswaList'));
    }
