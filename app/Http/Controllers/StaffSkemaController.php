...
class StaffSkemaController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('pages.staff.skema.index', compact('skema'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('pengaturan-skema.index');
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('pengaturan-skema.index')->with('error_message_not_found', 'Data skema tidak ditemukan');
        }
        $data = $request->all();
    ...
    public function destroy(string $id)
    {
        try {
            ...
            if ($skema->kkns()->count() > 0 ) {
                ...
                return redirect()->route('pengaturan-skema.index')->with('error_message_delete', $errorMessage);
            }
            $skema->delete();

            return redirect()->route('pengaturan-skema.index')->with('success_message_delete', 'Data skema berhasil dihapus');
        } catch (ModelNotFoundException $e) {
            return redirect()->route('pengaturan-skema.index')->with('error_message_not_found', 'Data skema tidak ditemukan');
        } catch (QueryException $e) {
            if ($e->getCode() === '23000') {
