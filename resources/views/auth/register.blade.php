            ...
            <div id="multiStepsValidation" class="bs-stepper shadow-none">
              <div class="bs-stepper-header border-bottom-0">
                <div class="step" data-target="#accountDetailsValidation">
                  <button type="button" class="step-trigger">
                    ...
                    <span class="bs-stepper-label">
                      ...
                      <span class="bs-stepper-subtitle">Akun Detail</span>
                    </span>
                  </button>
                </div>
                <div class="line">
                ...
                <div class="step" data-target="#billingLinksValidation">
                  <button type="button" class="step-trigger">
                    <span class="bs-stepper-circle"><i class="ti ti-mail ti-sm"></i></span>
                    <span class="bs-stepper-label">
                      <span class="bs-stepper-title">Aktivasi</span>
                      <span class="bs-stepper-subtitle">Aktivasi Email</span>
                    </span>
                  </button>
                </div>
              </div>
                ...
                <form id="multiStepsForm" onSubmit="return false">
                  ...
                  <div id="accountDetailsValidation" class="content">
                    <div class="content-header mb-4">
                      ...
                      <p>Masukan Detail Informasi Akun Anda</p>
                    </div>
                    <div class="row g-3">
                      <div class="col-sm-12">
