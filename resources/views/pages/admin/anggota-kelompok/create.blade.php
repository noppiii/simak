...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
            <form class="card-body" action="{{ route('create.anggota.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => request()->route('kelompok_id')]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
