        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="col-lg-8 mb-4 col-md-12">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="{{ route('create.anggota.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => request()->route('kelompok_id')]) }}"
                  ...
                  <form class="card-body" action="{{ route('edit.dpl.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => request()->route('kelompok_id')]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  <div class="col-md-12">
                    <div class="card mb-4">
...
<div class="modal-dialog modal-md" role="document">
  <div class="modal-content text-center">
    ...
    <form method="POST" action="{{ route('delete.anggota.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => request()->route('kelompok_id'), 'mahasiswa_id' => $data->mahasiswa_id]) }}">
      @csrf
      @method('DELETE')
