   ...
   <div class="modal-dialog modal-lg modal-simple modal-edit-user">
     <div class="modal-content p-3 p-md-5">
       <div class="modal-body">
         ...
         <form id="addNewCCForm" class="row g-3" action="{{ route('edit.status.berkas', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'nim' => request()->route('nim'), 'berkas_id' => $data->berkas_id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12 col-md-12">
