        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="col-lg-12 mb-12 col-md-12">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <form action="{{ route('list.berkas.mahasiswa', ['nama' => request()->route('nama'), 'periode' => request()->route('periode')]) }}" method="GET">
                            <div class="card-body demo-vertical-spacing demo-only-element">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    $url = route('list.berkas.mahasiswa', array_merge(['nama' => request()->route('nama'), 'periode' => request()->route('periode')], $urlParams));
                          ...
                          <div class="d-flex justify-content-between flex-sm-row flex-column">
                            ...
                            <div class="d-flex flex-column text-start text-lg-end">
                                <div class="d-flex order-sm-0 order-1 mt-3 ms-auto">
                                    <a href="{{ route('list.berkas.berkas',  ['nama' => request()->route('nama'), 'periode' => request()->route('periode'), 'nim' =>$data->nim]) }}"class="btn btn-label-primary me-3">
