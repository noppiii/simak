...
<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card h-100">
                      ...
                      >
                        <small>Tambah Fakultas</small>
                            ...
                            <small class="mb-0 mt-1">Tambah fakultas akademik</small>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    data-bs-target="#viewUser{{ $data->fakultas_id }}"
                                    class="dropdown-item"><i class="ti ti-eye me-1"></i>View
                                </button>
                                <button data-bs-toggle="modal"
                                data-bs-target="#editUser{{ $data->fakultas_id }}"
                                class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit
                                </button>
                                    <div class="dropdown-divider"></div>
                                    <button  data-bs-toggle="modal"
                                    data-bs-target="#onboardHorizontalImageModal{{ $data->fakultas_id }}"
      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <div class="text-center mb-4">
            <h3 class="mb-2">Tambah Fakultas</h3>
            <p class="text-muted">Tambah fakultas untuk keperluan akademik</p>
          </div>
          <form id="addNewCCForm" class="row g-3" action="{{ route('fakultas.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
              <label class="form-label w-100" for="modalAddCard">Nama Fakultas</label>
  ...
  {{-- ============= SHOW DATA =============== --}}
  @foreach ($fakultas as $data)
  <div class="modal fade" id="viewUser{{ $data->fakultas_id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Fakultas</label>
              <div class="input-group input-group-merge">
                <span class="input-group-text"><i class="ti ti-signature"></i></span>
                <input
                id="modalAddCard"
            ...
            <div class="col-12 col-md-12">
                <label class="form-label" for="modalEditUserName">Jumlah Dosen Pembimbing Lapangan</label>
                <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="card-title mb-0">
                                        <h6 class="mb-0 me-2">
                                            @if (!is_null($prodi->dpls))
                                                <ul>
                                                    @foreach ($prodi->dpls as $dpl)
                                                    {{ $dpl->count() > 0 ? $dpl->count() : '0' }}
                                                    @endforeach
                                                </ul>
                                            @else
                                                <p>Tidak ada DPL terkait.</p>
                                            @endif
                                        </h6>
  ...
  {{-- ==================== EDIT DATA =========================== --}}
  @foreach ($fakultas as $data)
  <div class="modal fade" id="editUser{{ $data->fakultas_id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <form id="addNewCCForm" class="row g-3" action="{{ route('fakultas.update', $data->fakultas_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Fakultas</label>
  ...
  id="onboardHorizontalImageModal{{ $data->fakultas_id }}"
  tabindex="-1"
  aria-hidden="true"
>
      ...
      <div class="modal-body onboarding-horizontal p-0">
        ...
        <div class="onboarding-content mb-0">
          ...
          <small class="onboarding-info">
            Dengan menghapus {{ $data->nama }}, fakultas ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('fakultas.destroy', $data->fakultas_id) }}">
        @csrf
        @method('DELETE')
