...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
            <form class="card-body" action="{{ route('wilayah-kecamatan.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select id="select2Icons" name="kabupaten_id" class="select2-icons form-select">
                                ...
                                <option value="{{ $data->kabupaten_id }}" data-icon="ti ti-location">{{ $data->nama }}</option>
                            @endforeach
                              </select>
                        </div>
                      </div>
