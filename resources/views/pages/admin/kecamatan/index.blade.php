                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('wilayah-kecamatan.edit', $data->kecamatan_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
...
>
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content text-center">
      ...
      <form method="POST" action="{{ route('wilayah-kecamatan.destroy', $data->kecamatan_id) }}">
        @csrf
        @method('DELETE')
