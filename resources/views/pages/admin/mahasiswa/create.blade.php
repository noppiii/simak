...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('mahasiswa.store') }}" method="post" enctype="multipart/form-data">
                @csrf
              <h6>1. Detail Akun</h6>
              <div class="row g-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            ...
                            ></span>
                            <input type="text" class="form-control" placeholder="YYYY-MM-DD" id="flatpickr-date" name="tanggal_lahir" />
                          </div>
                    </div>
                  </div>
                  <div class="row mb-3">
                        ...
                        <select id="select2Icons" name="prodi_id" class="select2-icons form-select">
                            ...
                            <optgroup label="{{ $fakultasItem->nama }}">
                                @foreach($fakultasItem->prodis as $prodi)
                                    <option value="{{ $prodi->prodi_id }}" data-icon="ti ti-building">{{ $prodi->nama }}</option>
                                @endforeach
                            </optgroup>
                            @endforeach
                          </select>
