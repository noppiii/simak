                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="{{ route('penataan-persyaratan.create') }}"
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('penataan-persyaratan.edit', $data->persyaratan_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
...
>
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content text-center">
      ...
      <form method="POST" action="{{ route('penataan-persyaratan.destroy', $data->persyaratan_id) }}">
        @csrf
        @method('DELETE')
