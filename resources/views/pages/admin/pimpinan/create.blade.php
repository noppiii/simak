        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    <h5 class="text-primary">Tambah Pimpinan</h5>
                    <p>Di sini anda dapat menambahkan user sebagai pimpinan, tolong isi form dengan benar</p>
         ...
         <div class="card mb-4">
             <form class="card-body" action="{{ route('pimpinan.store') }}" method="post" enctype="multipart/form-data">
                @csrf
              <h6>1. Detail Akun</h6>
              <div class="row g-3">
