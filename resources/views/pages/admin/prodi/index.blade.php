...
<div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          ...
                          >
                            ...
                            <small class="mb-0 mt-1">Tambah program studi akademik</small>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    data-bs-target="#viewUser{{ $data->prodi_id }}"
                                    class="dropdown-item"><i class="ti ti-eye me-1"></i>View
                                </button>
                                <a href="{{ route('program-studi.edit', $data->prodi_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
                                    <div class="dropdown-divider"></div>
                                    <button  data-bs-toggle="modal"
                                    data-bs-target="#onboardHorizontalImageModal{{ $data->prodi_id }}"
  ...
  {{-- ============= SHOW DATA =============== --}}
  @foreach ($prodi as $data)
  <div class="modal fade" id="viewUser{{ $data->prodi_id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Program Studi</label>
  ...
  id="onboardHorizontalImageModal{{ $data->prodi_id }}"
  tabindex="-1"
  aria-hidden="true"
>
      ...
      <div class="modal-body onboarding-horizontal p-0">
        ...
        <div class="onboarding-content mb-0">
          ...
          <small class="onboarding-info">
            Dengan menghapus {{ $data->nama }}, program studi ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('program-studi.destroy', $data->prodi_id) }}">
        @csrf
        @method('DELETE')
