...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-lg-12 mb-4 order-0">
         ...
         <div class="card mb-4">
            <form class="card-body" action="{{ route('staff.update', $staff->user_id) }}" method="post" enctype="multipart/form-data">                @csrf
                @csrf
                @method('PUT')
              <h6>1. Detail Akun</h6>
              <div class="row g-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select id="select2Basic" name="jenis_kelamin" class="select2-icons form-select">
                            <option value="Laki-Laki" {{ $staff->staff->jenis_kelamin === 'Laki-Laki' ? 'selected' : '' }} data-icon="ti ti-gender-male" selected>Laki-Laki</option>
                            <option value="Perempuan" {{ $staff->staff->jenis_kelamin === 'Perempuan' ? 'selected' : '' }} data-icon="ti ti-gender-femme">Perempuan</option>
                          </select>
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="avatar avatar-xl mt-2">
                            <img src="{{ asset('store/user/photo/staff/' . $staff->staff->foto) }}" alt="Avatar" class="rounded-circle" />
                          </div>
                         @else
