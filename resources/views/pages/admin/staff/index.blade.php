              ...
              <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                  <div class="card-body">
                    ...
                    <p>Di sini Anda dapat mengontrol dan mengelola semua aspek staff</p>
            ...
            <div class="col-lg-8 mb-4 col-md-12">
                <div class="card">
                  <div class="card-header d-flex justify-content-between">
                    <h5 class="card-title mb-0">Statistics Staff</h5>
                    ...
                    <div class="row gy-3">
                      ...
                      <div class="col-md-4 col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="card-info">
                            <h5 class="mb-0">{{ $newStaffThisMonth }}</h5>
                            <small>Staff Baru Bulan Ini</small>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-5 col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="card-info">
                            <h5 class="mb-0 text-success">{{ $newStaff }}</h5>
                            <small>Staff Baru</small>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            ...
                            <small class="mb-0 mt-1">Tambah staff untuk manage resource</small>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <table class="datatables-basic table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->email }}</td>
                            <td>{{ $data->staff->telp }}</td>
                            <td>{{ $data->role->role_name }}</td>
                            <td>
                                <div class="avatar avatar-md">
                                <img src="{{ asset('store/user/photo/staff/' . $data->staff->foto) }}" alt="Avatar" class="rounded-circle" />
                              </div>
                            </td>
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    <a href="{{ route('staff.edit', $data->user_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <div class="text-center mb-4">
            <h3 class="mb-2">{{ $data->staff->nama }}</h3>
            <p class="text-muted">Informasi tentang user {{ $data->staff->nama }}.</p>
          </div>
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            ...
            <div class="col-12 col-md-6">
                ...
                <input
                  ...
                  value="{{ $data->staff->jenis_kelamin }}"
                />
              </div>
              <div class="col-12">
    ...
    <div class="modal-content text-center">
      ...
      <div class="modal-body onboarding-horizontal p-0 d-block">
        ...
        <div class="onboarding-content mb-0">
          <h4 class="onboarding-title text-body text-danger">Hapus {{ $data->staff->nama }}</h4>
          <small class="onboarding-info">
            Dengan menghapus {{ $data->staff->nama }}, data ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('staff.destroy', $data->user_id) }}">
        @csrf
        @method('DELETE')
