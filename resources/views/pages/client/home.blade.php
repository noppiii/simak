 ...
 <section id="hero">
    ...
    <div class="product-screens">
      ...
      <div class="product-screen-1" data-aos="fade-up" data-aos-delay="400">
        <img src="{{ asset('home/assets/img/product-screen-1.png') }}" alt="">
      </div>

      <div class="product-screen-2" data-aos="fade-up" data-aos-delay="200">
        <img src="{{ asset('home/assets/img/product-screen-2.png') }}" alt="">
      </div>

      <div class="product-screen-3" data-aos="fade-up">
        <img src="{{ asset('home/assets/img/product-screen-3.png') }}" alt="">
      </div>
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 about-img" data-aos="fade-right" dat-aos-delay="100">
            <img src="{{ asset('home/assets/img/about-img.jpg') }}" alt="">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
            <img src="{{ asset('home/assets/img/product-features.png') }}" alt="" data-aos="fade-right">
          </div>
    ...
    <section id="advanced-features">
      ...
      <div class="features-row section-bg" data-aos="fade-up">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ asset('home/assets/img/advanced-feature-1.jpg') }}" alt="">
              <div>
      ...
      <div class="features-row" data-aos="fade-up">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-left" src="{{ asset('home/assets/img/advanced-feature-2.jpg') }}" alt="">
              <div>
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
      ...
      <div class="features-row section-bg" data-aos="fade-up">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <img class="advanced-feature-img-right wow fadeInRight" src="{{ asset('home/assets/img/advanced-feature-3.jpg') }}" alt="">
              <div>
                <h2>Duis aute irure dolor in reprehenderit in voluptate velit esse</h2>
                <h3>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
    ...
    <section id="clients">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-1.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-2.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-3.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-4.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-5.png') }}" alt="">
          </div>

          <div class="col-md-2">
            <img src="{{ asset('home/assets/img/clients/client-6.png') }}" alt="">
          </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-1.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-1.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-2.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-2.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-3.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-3.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-4.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-4.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-5.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-5.jpg') }}" alt="">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="gallery-item">
              <a href="{{ asset('home/assets/img/gallery/gallery-6.jpg') }}" data-gall="portfolioGallery" class="gallery-lightbox">
                <img src="{{ asset('home/assets/img/gallery/gallery-6.jpg') }}" alt="">
              </a>
            </div>
          </div>
