        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="col-lg-12 mb-4 col-md-12">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <form action="{{ route('dosen.list.kkn.mhs') }}" method="GET">
                                ...
                                <div class="d-flex justify-content-center">
                                    @foreach ($skema as $data)
                                        @php
                                            ...
                                            $url = route('dosen.list.kkn.mhs', $urlParams);
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <a href="{{ route('dosen.list.kkn.kelompok', ['nama' => $data->nama, 'periode' => $data->periode->nama]) }}" class="d-flex align-items-center">
                                            @php
