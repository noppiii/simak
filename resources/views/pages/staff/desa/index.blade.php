                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="{{ route('daerah-desa.create') }}"
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('daerah-desa.edit', $data->desa_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
...
>
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content text-center">
      ...
      <form method="POST" action="{{ route('daerah-desa.destroy', $data->desa_id) }}">
        @csrf
        @method('DELETE')
