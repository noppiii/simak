    ...
    <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <form id="addNewCCForm" class="row g-3" action="{{ route('daerah-kabupaten.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
    ...
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <form id="addNewCCForm" class="row g-3" action="{{ route('daerah-kabupaten.update', $data->kabupaten_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Kabupaten</label>
...
>
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content text-center">
      ...
      <form method="POST" action="{{ route('daerah-kabupaten.destroy', $data->kabupaten_id) }}">
        @csrf
        @method('DELETE')
