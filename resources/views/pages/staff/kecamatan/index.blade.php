...
<div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="{{ route('daerah-kecamatan.create') }}"
                            class="btn btn-primary mb-2 text-nowrap add-new-role" style="font-size: 12px;"
                          >
                            Tambah Kecamatan
                          </a>
                            <small class="mb-0 mt-1">Tambah wilayah kecamatan</small>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    data-bs-target="#viewUser{{ $data->kecamatan_id }}"
                                    class="dropdown-item"><i class="ti ti-eye me-1"></i>View
                                </button>
                                <a href="{{ route('daerah-kecamatan.edit', $data->kecamatan_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
                                    <div class="dropdown-divider"></div>
                                    <button  data-bs-toggle="modal"
                                    data-bs-target="#onboardHorizontalImageModal{{ $data->kecamatan_id }}"
  ...
  {{-- ============= SHOW DATA =============== --}}
  @foreach ($kecamatan as $data)
  <div class="modal fade" id="viewUser{{ $data->kecamatan_id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Kecamatan</label>
  ...
  id="onboardHorizontalImageModal{{ $data->kecamatan_id }}"
  tabindex="-1"
  aria-hidden="true"
>
      ...
      <div class="modal-body onboarding-horizontal p-0">
        ...
        <div class="onboarding-content mb-0">
          ...
          <small class="onboarding-info">
            Dengan menghapus {{ $data->nama }}, kecamatan ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('daerah-kecamatan.destroy', $data->kecamatan_id) }}">
        @csrf
        @method('DELETE')
