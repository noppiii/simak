        ...
        <div class="col-lg-12 mb-4 order-0">
            ...
            <div class="col-lg-8 mb-4 col-md-12">
              ...
              <div class="container-xxl flex-grow-1 container-p-y">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <form action="{{ route('staff.list.kkn.kelompok', ['nama' => request()->route('nama'), 'periode' => request()->route('periode')]) }}" method="GET">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-end mt-1">
                            <div class="role-heading">
                              ...
                              <a
                                href="{{ route('staff.list.kkn.peserta', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama]) }}"
                                class="role-edit-modal"
                                ><span>Detail</span></a
                              >
                            </div>
                            <a href="{{ route('staff.list.kkn.peserta', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama]) }}" class="text-muted"><i class="ti ti-arrow-narrow-right ti-md"></i></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-end mt-1">
                            <div class="role-heading">
                              <a href="{{ route('staff.list.anggota.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => $data->kelompok_id ]) }}" class="h4 mb-1">{{ $data->nama }}</a>
                              <a
                                href="javascript:;"
                                data-bs-toggle="modal"
    ...
    <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <form id="addNewCCForm" class="row g-3" action="{{ route('staff.generate.kelompok', ['kknId' => $kkn->kkn_id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
  ...
  <div class="modal-onboarding modal fade animate__animated" id="onboardHorizontalImageModal{{ $data->kelompok_id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content text-center">
        ...
        <form method="POST" action="{{ route('staff.delete.kelompok', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama, 'kelompok_id' => $data->kelompok_id ]) }}">
          @csrf
          @method('DELETE')
...
<script>
    $(document).ready(function () {
        $('#ambilDataPesertaBtn').on('click', function () {
            $.ajax({
                url: '{{ route('staff.get.peserta.data', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama]) }}',
                method: 'GET',
...
$(document).ready(function () {
    ...
    $('#ambilDataPesertaBtn').on('click', function () {
        $.ajax({
            url: '{{ route('staff.get.prodi.data', ['nama' => $kkn->nama, 'periode' => $kkn->periode->nama]) }}',
            method: 'GET',
            success: function (data) {
                var selectOptions = '';
