...
<div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card h-100">
                      ...
                      >
                        <small>Tambah Periode</small>
                            ...
                            <small class="mb-0 mt-1">Tambah periode KKN</small>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    data-bs-target="#viewUser{{ $data->periode_id }}"
                                    class="dropdown-item"><i class="ti ti-eye me-1"></i>View
                                </button>
                                <button data-bs-toggle="modal"
                                data-bs-target="#editUser{{ $data->periode_id }}"
      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <div class="text-center mb-4">
            <h3 class="mb-2">Tambah Periode</h3>
            <p class="text-muted">Tambah periode untuk kegiatan KKN</p>
          </div>
          <form id="addNewCCForm" class="row g-3" action="{{ route('pengaturan-periode.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="col-12">
              <label class="form-label w-100" for="modalAddCard">Nama Periode</label>
  ...
  {{-- ============= SHOW DATA =============== --}}
  @foreach ($periode as $data)
  <div class="modal fade" id="viewUser{{ $data->periode_id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Periode</label>
              <div class="input-group input-group-merge">
                <span class="input-group-text"><i class="ti ti-signature"></i></span>
                <input
                id="modalAddCard"
            ...
            <div class="col-12 col-md-12">
                <label class="form-label" for="modalEditUserName">Daftar KKN Pada Periode {{ $data->nama }}</label>
                <div class="row">
  ...
  {{-- ==================== EDIT DATA =========================== --}}
  @foreach ($periode as $data)
  <div class="modal fade" id="editUser{{ $data->periode_id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <form id="addNewCCForm" class="row g-3" action="{{ route('pengaturan-periode.update', $data->periode_id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Periode</label>
      ...
      <div class="modal-body onboarding-horizontal p-0">
        ...
        <div class="onboarding-content mb-0">
          ...
          <small class="onboarding-info">
            Dengan menghapus {{ $data->nama }}, periode ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('pengaturan-periode.destroy', $data->periode_id) }}">
        @csrf
        @method('DELETE')
