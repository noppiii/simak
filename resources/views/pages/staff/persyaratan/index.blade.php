...
<div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="row h-100">
                        ...
                        <div class="col-sm-7">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="{{ route('pengaturan-persyaratan.create') }}"
                            class="btn btn-primary mb-2 text-nowrap add-new-role" style="font-size: 11px;"
                          >
                            Tambah Persyaratan
                          </a>
                            <small class="mb-0 mt-1">Tambah persyaratan KKN</small>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-inline-block">
                                    ...
                                    data-bs-target="#viewUser{{ $data->persyaratan_id }}"
                                    class="dropdown-item"><i class="ti ti-eye me-1"></i>View
                                </button>
                                <a href="{{ route('pengaturan-persyaratan.edit', $data->persyaratan_id) }}" class="dropdown-item"><i class="ti ti-pencil me-1"></i>Edit</a>
                                    <div class="dropdown-divider"></div>
                                    <button  data-bs-toggle="modal"
                                    data-bs-target="#onboardHorizontalImageModal{{ $data->persyaratan_id }}"
  ...
  {{-- ============= SHOW DATA =============== --}}
  @foreach ($persyaratan as $data)
  <div class="modal fade" id="viewUser{{ $data->persyaratan_id }}" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <form id="editUserForm" class="row g-3" onsubmit="return false">
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">Nama Persyaratan</label>
            ...
            <div class="col-12 col-md-12">
              <label class="form-label" for="modalEditUserName">KKN</label>
              <div class="input-group input-group-merge">
  ...
  id="onboardHorizontalImageModal{{ $data->persyaratan_id }}"
  tabindex="-1"
  aria-hidden="true"
>
      ...
      <div class="modal-body onboarding-horizontal p-0">
        ...
        <div class="onboarding-content mb-0">
          ...
          <small class="onboarding-info">
            Dengan menghapus {{ $data->nama }}, persyaratan ini akan terhapus secara permanen.
          </small>
        </div>
      </div>
      <form method="POST" action="{{ route('pengaturan-persyaratan.destroy', $data->persyaratan_id) }}">
        @csrf
        @method('DELETE')
